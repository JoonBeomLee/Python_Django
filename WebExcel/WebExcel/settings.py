"""
Django settings for WebExcel project.
...
SECRET_KEY = 'dhd+y_1&48-j3s$dneisvoz@!)6m+hq^6fx&e4ms%631sr^=lu'
...
WSGI_APPLICATION = 'WebExcel.wsgi.application'
